...
# def advanced_h(board,car):
#     red_car = get_red_car(board)
#     bad_cars = blocking_cars(board,red_car)
#     for car in bad_cars:
#         a = blocking_cars(board,car)
...
class state:
    def __init__(self, current_board,current_cost,father_state):
        ...
        # print('blocking_heu:',blocking_cars(self.board, self.red_car))
        # self.advanced_heu = advanced_h(board,self.red_car)
        self.f = self.cost # should + something
